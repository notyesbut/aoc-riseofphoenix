...
{
public:
	struct FStructBaseChain                       BaseChain;                                         // 0x0050(0x0010)(NOT AUTO-GENERATED PROPERTY)
	class UStruct*                                SuperStruct;                                       // 0x0060(0x0008)(NOT AUTO-GENERATED PROPERTY)
	...
	int16                                         MinAlignment;                                      // 0x007C(0x0002)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_7E[0x52];                                      // 0x007E(0x0052)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	EUserDefinedStructureStatus                   Status;                                            // 0x00E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E1[0x3];                                       // 0x00E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  Guid;                                              // 0x00E4(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	EVerseEnumFlags                               VerseEnumFlags;                                    // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FUtf8String                                   QualifiedName;                                     // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class UObject*                                ClassDefaultObject;                                // 0x0150(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
public:
	...
	uint32                                        FunctionFlags;                                     // 0x00D0(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
public:
	...
	FUtf8String                                   QualifiedName;                                     // 0x00E8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFunction*                              InitFunction;                                      // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TSubclassOf<class UObject>                    ModuleClass;                                       // 0x0100(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	struct FGuid                                  Guid;                                              // 0x0108(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFunction*                              FactoryFunction;                                   // 0x0118(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UFunction*                              OverrideFactoryFunction;                           // 0x0120(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	EVerseEffectSet                               ConstructorEffects;                                // 0x0128(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FObjectCookedMetaDataStore             EnumMetaData;                                      // 0x0048(0x0050)(Protected, NativeAccessSpecifierProtected)
...
{
public:
	struct FStructCookedMetaDataStore             StructMetaData;                                    // 0x0048(0x00A0)(Protected, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                         Pad_240[0x1C0];                                    // 0x0240(0x01C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint32                                        SolClassFlags;                                     // 0x0240(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_244[0x4];                                      // 0x0244(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UObject>>            TaskClasses;                                       // 0x0248(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
	class UFunction*                              InitInstanceFunction;                              // 0x0258(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TArray<struct FVersePersistentVar>            PersistentVars;                                    // 0x0260(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FVerseSessionVar>               SessionVars;                                       // 0x0270(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FVerseClassVarAccessors> VarAccessors;                                  // 0x0280(0x0050)(NativeAccessSpecifierPublic)
	EVerseEffectSet                               ConstructorEffects;                                // 0x02D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D1[0x3];                                      // 0x02D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   MangledPackageVersePath;                           // 0x02D4(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2DC[0x4];                                      // 0x02DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 PackageRelativeVersePath;                          // 0x02E0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, class FName>                DisplayNameToUENameFunctionMap;                    // 0x02F0(0x0050)(NativeAccessSpecifierPublic)
	TArray<TSubclassOf<class UObject>>            DirectInterfaces;                                  // 0x0340(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
	TArray<TFieldPath<class FProperty>>           PropertiesWrittenByInitCDO;                        // 0x0350(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, class FName>                FunctionMangledNames;                              // 0x0360(0x0050)(NativeAccessSpecifierPublic)
	TArray<class FName>                           PredictsFunctionNames;                             // 0x03B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
