...
public:
	...
	struct FRigVMGraphFunctionStore               GraphFunctionStore;                                // 0x03A8(0x0020)(NativeAccessSpecifierPublic)
...
{
public:
	struct FRigVMMemoryStorageStruct              LiteralMemoryStorage;                              // 0x0048(0x0050)(NativeAccessSpecifierPublic)
	struct FRigVMMemoryStorageStruct              DefaultWorkMemoryStorage;                          // 0x0098(0x0050)(NativeAccessSpecifierPublic)
	struct FRigVMMemoryStorageStruct              DefaultDebugMemoryStorage;                         // 0x00E8(0x0050)(NativeAccessSpecifierPublic)
	uint8                                         Pad_138[0x20];                                     // 0x0138(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0158(0x00B0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_208[0x8];                                      // 0x0208(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMInstructionArray                 Instructions;                                      // 0x0210(0x0010)(Transient, NativeAccessSpecifierPrivate)
	...
	uint32                                        CachedVMHash;                                      // 0x0350(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_354[0x54];                                     // 0x0354(0x0054)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	TSoftObjectPtr<class UDataAsset>              DataAsset;                                         // 0x0120(0x0028)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDataAsset*                             DataAssetCached;                                   // 0x0148(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	class UObject*                                Subject;                                           // 0x0048(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	class URigVM*                                 VM;                                                // 0x0078(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	TMap<class FString, struct FSoftObjectPath>   UserDefinedStructGuidToPathName;                   // 0x0080(0x0050)(Protected, NativeAccessSpecifierProtected)
	TMap<class FString, struct FSoftObjectPath>   UserDefinedEnumToPathName;                         // 0x00D0(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          UserDefinedTypesInUse;                             // 0x0120(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	uint8                                         Pad_170[0x8];                                      // 0x0170(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMDrawContainer                    DrawContainer;                                     // 0x0178(0x0018)(NativeAccessSpecifierPublic)
	uint8                                         Pad_190[0x18];                                     // 0x0190(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           EventQueue;                                        // 0x01A8(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B8[0x68];                                     // 0x01B8(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UAssetUserData*>                 AssetUserData;                                     // 0x0220(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, AdvancedDisplay, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	TArray<struct FRigVMTag>                      VariantTags;                                       // 0x0058(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
