...
public:
	...
	TArray<class UWorldMetricInterface*>          Metrics;                                           // 0x0060(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	uint8                                         Pad_70[0x29E0];                                    // 0x0070(0x29E0)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         UpdateRateInSeconds;                               // 0x2A50(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         WarmUpFrames;                                      // 0x2A54(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
