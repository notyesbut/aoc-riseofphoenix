...
{
public:
	struct FGuid                                  AssetGuid;                                         // 0x0048(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	TMap<class FName, class UClothingInteractor*> ClothingInteractors;                               // 0x0048(0x0050)(UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
