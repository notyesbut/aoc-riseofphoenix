...
{
public:
	struct FButtonStyle                           ButtonStyle;                                       // 0x0050(0x03A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
{
public:
	struct FCheckBoxStyle                         CheckBoxStyle;                                     // 0x0050(0x0960)(Edit, NativeAccessSpecifierPublic)
...
// 0x05E0 (0x0630 - 0x0050)
class UComboBoxWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0050(0x05E0)(Edit, NativeAccessSpecifierPublic)
...
// 0x0570 (0x05C0 - 0x0050)
class UComboButtonWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0050(0x0570)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0050(0x0C80)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0050(0x0290)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	struct FProgressBarStyle                      ProgressBarStyle;                                  // 0x0050(0x0230)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
{
public:
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x0050(0x0650)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	struct FScrollBoxStyle                        ScrollBoxStyle;                                    // 0x0050(0x02F0)(Edit, NativeAccessSpecifierPublic)
...
// 0x0520 (0x0570 - 0x0050)
class USpinBoxWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	struct FSpinBoxStyle                          SpinBoxStyle;                                      // 0x0050(0x0520)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0050(0x02E0)(Edit, NativeAccessSpecifierPublic)
