...
public:
	...
	class FName                                   TargetPageName;                                    // 0x009C(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FMetaSoundPageSettings                 DefaultPageSettings;                               // 0x00A4(0x0018)(Edit, Config, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_BC[0x4];                                       // 0x00BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FMetaSoundPageSettings>         PageSettings;                                      // 0x00C0(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPrivate)
	TArray<struct FMetaSoundQualitySettings>      QualitySettings;                                   // 0x00D0(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FMetasoundFrontendDocument             RootMetaSoundDocument;                             // 0x0090(0x0190)(Edit, Protected, NativeAccessSpecifierProtected)
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x0220(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0270(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	struct FMetaSoundFrontendDocumentBuilder      Builder;                                           // 0x0048(0x0058)(Protected, NativeAccessSpecifierProtected)
...
{
public:
	TMap<class FName, class UMetaSoundBuilderBase*> NamedBuilders;                                   // 0x0050(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x0648(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0698(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x06E8(0x0050)(Protected, NativeAccessSpecifierProtected)
