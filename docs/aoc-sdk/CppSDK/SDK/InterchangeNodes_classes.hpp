...
// 0x0240 (0x02D0 - 0x0090)
class UInterchangeSkeletalAnimationTrackNode final : public UInterchangeAnimationTrackBaseNode
{
public:
	uint8                                         Pad_90[0x240];                                     // 0x0090(0x0240)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_80[0x198];                                     // 0x0080(0x0198)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x0430 (0x04B0 - 0x0080)
class UInterchangeSceneNode final : public UInterchangeBaseNode
{
public:
	uint8                                         Pad_80[0x430];                                     // 0x0080(0x0430)(Fixing Struct Size After Last Property [ Dumper-7 ])
