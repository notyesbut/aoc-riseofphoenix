...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0D6D20F0;
	constexpr int32 AppendString      = 0x01503A70;
	constexpr int32 GNames            = 0x0D5B4F90;
	constexpr int32 GWorld            = 0x0D23C390;
	constexpr int32 ProcessEvent      = 0x01745F00;
	constexpr int32 ProcessEventIdx   = 0x0000005D;
}
