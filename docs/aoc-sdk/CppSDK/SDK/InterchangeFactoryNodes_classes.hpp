...
{
public:
	uint8                                         Pad_1E0[0xA0];                                     // 0x01E0(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x02A0 (0x0480 - 0x01E0)
class UInterchangeTextureFactoryNode : public UInterchangeFactoryBaseNode
{
public:
	uint8                                         Pad_1E0[0x2A0];                                    // 0x01E0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_480[0x98];                                     // 0x0480(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_518[0x40];                                     // 0x0518(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x0340 (0x0520 - 0x01E0)
class UInterchangeAnimSequenceFactoryNode final : public UInterchangeFactoryBaseNode
{
public:
	uint8                                         Pad_1E0[0x340];                                    // 0x01E0(0x0340)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E0[0x190];                                    // 0x01E0(0x0190)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_370[0xA8];                                     // 0x0370(0x00A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F0[0x80];                                     // 0x01F0(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_370[0xF8];                                     // 0x0370(0x00F8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E0[0xB0];                                     // 0x01E0(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_370[0x118];                                    // 0x0370(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E0[0x240];                                    // 0x01E0(0x0240)(Fixing Struct Size After Last Property [ Dumper-7 ])
