...
{
public:
	class UInterchangeResultsContainer*           Results;                                           // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	class FString                                 DestinationName;                                   // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ContentImportPath;                                 // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowPropertyStatesEdition;                       // 0x0068(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsReimportContext;                                // 0x0069(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsShowEssentials;                                 // 0x006A(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TMap<class FName, struct FInterchangePipelinePropertyStates> CachePropertiesStates;              // 0x00C8(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
	struct FInterchangePipelineContextParams      CacheContextParam;                                 // 0x0118(0x0020)(Transient, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	class FString                                 AssetFriendlyName;                                 // 0x0068(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UObject>                    AssetType;                                         // 0x0078(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class FString                                 InterchangeKey;                                    // 0x0080(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class FText                                   Text;                                              // 0x0090(0x0010)(NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class UInterchangeResult*>             Results;                                           // 0x0070(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	TMap<class FString, class UObject*>           ContextObjectsByTag;                               // 0x0070(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	class UInterchangeResultsContainer*           Results;                                           // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UInterchangeSourceData*                 SourceData;                                        // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	TMap<class FString, class UInterchangeBaseNode*> Nodes;                                          // 0x0048(0x0050)(Edit, EditConst, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	uint8                                         Pad_80[0xE0];                                      // 0x0080(0x00E0)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class FString>                           AttributesAppliedThroughDelegatesKeySet;           // 0x0160(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                         Pad_80[0x138];                                     // 0x0080(0x0138)(Fixing Struct Size After Last Property [ Dumper-7 ])
