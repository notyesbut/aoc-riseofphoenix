...
public:
	...
	class UNetDriver*                             NetDriver;                                         // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TArray<class UNetReplicationGraphConnection*> Connections;                                       // 0x0058(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
	TArray<class UNetReplicationGraphConnection*> PendingConnections;                                // 0x0068(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
	uint8                                         Pad_78[0xF8];                                      // 0x0078(0x00F8)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UReplicationGraphNode*>          GlobalGraphNodes;                                  // 0x0170(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TArray<class UReplicationGraphNode*>          PrepareForReplicationNodes;                        // 0x0180(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	uint8                                         Pad_190[0xE0];                                     // 0x0190(0x00E0)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class AActor*>                           ActiveNetworkActors;                               // 0x0270(0x0050)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C0[0x348];                                    // 0x02C0(0x0348)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D* GridNode;                                      // 0x0608(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UReplicationGraphNode_ActorList*        AlwaysRelevantNode;                                // 0x0610(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TArray<struct FConnectionAlwaysRelevantNodePair> AlwaysRelevantForConnectionList;                // 0x0618(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         ActorsWithoutNetConnection;                        // 0x0628(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	TArray<class UReplicationGraphNode*>          AllChildNodes;                                     // 0x0048(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	class UReplicationGraphNode*                  DynamicNode;                                       // 0x0120(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class UReplicationGraphNode_DormancyNode*     DormancyNode;                                      // 0x0128(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	class UReplicationGraphNode*                  ChildNode;                                         // 0x0070(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	class UNetConnection*                         NetConnection;                                     // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	...
	TArray<class UReplicationGraphNode*>          ConnectionGraphNodes;                              // 0x0288(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                  // 0x0298(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x0368(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x0370(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
