...
{
public:
	struct FRuntimeFloatCurve                     CurveInfo;                                         // 0x0000(0x0090)(Edit, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FStateTreeConsiderationResponseCurve   ResponseCurve;                                     // 0x0028(0x0090)(Edit, NativeAccessSpecifierPublic)
};
