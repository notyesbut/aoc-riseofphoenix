...
{
public:
	TMap<class FName, struct FNodeColors>         NodeColorsMap;                                     // 0x0058(0x0050)(Edit, Config, NativeAccessSpecifierPublic)
	TMap<class FName, struct FPinSettings>        PinSettingsMap;                                    // 0x00A8(0x0050)(Edit, Config, NativeAccessSpecifierPublic)
	struct FTransformLevelColors                  TransformLevelColors;                              // 0x00F8(0x0020)(Edit, Config, NativeAccessSpecifierPublic)
