...
public:
	...
	uint8                                         Pad_924[0x6FC];                                    // 0x0924(0x06FC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FSourceEffectBitCrusherSettings        Settings;                                          // 0x0160(0x00B0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
{
public:
	class UAudioImpulseResponse*                  ImpulseResponse;                                   // 0x0088(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	struct FSourceEffectDynamicsProcessorSettings Settings;                                          // 0x00DC(0x002C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	class USoundWave*                             GranulatedSoundWave;                               // 0x0920(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	class UMonoWaveTableSynthPreset*              CurrentPreset;                                     // 0x0940(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	struct FRuntimeFloatCurve                     DistanceAttenuationCurve;                          // 0x0928(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVector2D                              DistanceRange;                                     // 0x09B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AttenuationDbAtMaxRange;                           // 0x09C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9CC[0x44];                                     // 0x09CC(0x0044)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class USoundWave*                             SoundWave;                                         // 0x0920(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	TDelegate<void()>                             ValueXDelegate;                                    // 0x0198(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void()>                             ValueYDelegate;                                    // 0x01A8(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B8[0x8];                                      // 0x01B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSynth2DSliderStyle                    WidgetStyle;                                       // 0x01C0(0x0390)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
