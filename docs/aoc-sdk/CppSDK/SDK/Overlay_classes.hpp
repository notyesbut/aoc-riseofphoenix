...
{
public:
	class UBasicOverlays*                         DefaultOverlays;                                   // 0x0048(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TMap<class FString, class UBasicOverlays*>    LocaleToOverlaysMap;                               // 0x0050(0x0050)(Edit, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
