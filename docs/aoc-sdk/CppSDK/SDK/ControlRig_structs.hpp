...
public:
	...
	struct FRuntimeFloatCurve                     WaveCurve;                                         // 0x00F0(0x0090)(Edit, BlueprintVisible, EditConst, NativeAccessSpecifierPublic)
...
public:
	...
	struct FRuntimeFloatCurve                     WaveCurve;                                         // 0x00F8(0x0090)(Edit, BlueprintVisible, EditConst, NativeAccessSpecifierPublic)
	struct FRigUnit_ChainHarmonics_Pendulum       Pendulum;                                          // 0x0188(0x0058)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bDrawDebug;                                        // 0x01E0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E1[0xF];                                      // 0x01E1(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             DrawWorldOffset;                                   // 0x01F0(0x0060)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigUnit_ChainHarmonics_WorkData       WorkData;                                          // 0x0250(0x0098)(Transient, NativeAccessSpecifierPublic)
